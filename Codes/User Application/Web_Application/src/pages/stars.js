...
const Stars = () => {
  ...
  const stars = ["Achernar", "Achird", "Adhil", "Adhara", "Ain", "Acrab", "Acrux", "Acubens",
  ...
  return (
      <div style={{ padding: '20px' }}>
        <h1 style={{ fontSize: '2em', textAlign: 'center', marginBottom: '20px' }}>Stars</h1>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(150px, 1fr))', gridGap: '20px' }}>
        {stars.map(star => (
          <div onClick={() => handleItemClick(star)} style={{ backgroundColor: '#ccc', padding: '20px', borderRadius: '8px', cursor: 'pointer', textAlign: 'center' }}
